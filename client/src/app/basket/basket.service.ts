...
export class BasketService {
  ...
  incrementItemQuantity(itme: IBasketItem) {
    const basket = this.getCurrentBasketValue();
    const foundItemIndex = basket.items.findIndex(x => x.id === itme.id);
  ...
  private createBasket(): IBasket {
    ...
    localStorage.setItem('basket_id', basket.id); // localstorage presist - pacific to browser
    return basket;
  }
